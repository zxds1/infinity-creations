      ...
      <div className="min-h-screen bg-brand-cream selection:bg-brand-primary/20 flex flex-col">
        ...
        <div className="flex flex-1 flex-col lg:flex-row">
          ...
          <main className="flex-1 lg:pl-20 transition-all duration-300">
            ...
            <footer className="py-24 border-t border-brand-primary/10 bg-white mt-12">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-stone-400 max-w-sm leading-relaxed mb-8">
                  Premium interior design, custom furniture, and professional branding services. Elevating spaces with a touch of magic.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-4 text-stone-500 text-sm">
                  <li><Link to="/analyzer" className="hover:text-brand-primary">AI Space Analyzer</Link></li>
            ...
            <div className="max-w-7xl mx-auto px-4 mt-24 pt-12 border-t border-brand-primary/5 flex flex-col md:flex-row justify-between items-center gap-6">
